...
namespace task4
{
    ...
    class Observer1
    {
        public void DisplayMessage(string message) => Console.WriteLine($"1 обработчик: {message}");
    }
    class Observer2
    {
        public void DisplayMessage(string message) => Console.WriteLine($"2 обработчик: {message}");
    }
    class Program
    {
