...
namespace task3
{
    class Program
    {
        ...
        {
            string file1 = "O:\\колледж\\КПиЯП-практика\\Задания\\task16\\task3\\text1.txt";
            string file2 = "O:\\колледж\\КПиЯП-практика\\Задания\\task16\\task3\\text2.txt";
            string file3 = "O:\\колледж\\КПиЯП-практика\\Задания\\task16\\task3\\text3.txt";
            ...
            Console.WriteLine("b)Количество строк: " + kol);

            Console.WriteLine("c)");
            for (int i = 0; i < numbers.Length; i++)
            {
                Console.WriteLine($"Количество символов в {i + 1} строке: {CountNotProbelov(numbers[i])}");
            }
